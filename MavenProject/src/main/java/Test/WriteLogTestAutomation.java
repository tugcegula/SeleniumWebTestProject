...
public class WriteLogTestAutomation {
    ...
    public static String email = "gittigidiyortest21@gmail.com";
    public static String sifre = "selenium21";
    ...
    public void logIn() throws Exception {
        ...
        driver.get(baseUrl);
        // ana sayfanýn açýlýp açýlmadýðý kontrol ediliyor
        ...
        //login olunmuþ mu konrol ediliyor
